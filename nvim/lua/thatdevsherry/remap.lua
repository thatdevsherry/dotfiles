...
vim.keymap.set("n", "<C-k>", "<cmd>lua vim.diagnostic.goto_next()<CR>", { desc = "Go to next error" })
vim.keymap.set("n", "<C-j>", "<cmd>lua vim.diagnostic.goto_prev()<CR>", { desc = "Go to previous error" })
